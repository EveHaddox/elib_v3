...
Elib.GetImage("https://pixel-cdn.lythium.dev/i/zxlflz5vp", function(mat)
    gradientMat = mat
end)

local colorWheelMat = Material("nil")
Elib.GetImage("https://pixel-cdn.lythium.dev/i/4lsnfph3b", function(mat)
    colorWheelMat = mat
end)

local pickerMat = Material("nil")
Elib.GetImage("https://pixel-cdn.lythium.dev/i/rhz6llj2", function(mat)
    pickerMat = mat
end)
...
function PANEL:UpdateColor()
    self.Color = Elib.HSLToColor(self.Hue, self.Saturation, self.Lightness)
...
function PANEL:GetHueColor()
    return Elib.HSLToColor(self.Hue, 1, 0.5)
end
...
function PANEL:Paint(w, h)
    ...
    local pickerVerts = {
        ...
        {
            x = cX + self.TriX * triangleRadius - Elib.Scale(5),
            y = cY + self.TriY * triangleRadius + Elib.Scale(5),
            u = 0,
            v = 1
        },
        {
...
vgui.Register("Elib.ColorPicker", PANEL, "Panel")