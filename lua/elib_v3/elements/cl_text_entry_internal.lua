...
function PANEL:Init()
    ...
    self:SetTall(Elib.Scale(34))

    self.m_bLoseFocusOnClickAway = true

    self:SetCursor("beam")
    self:SetFontInternal(Elib.GetRealFont("UI.TextEntry"))
end
...
function PANEL:Paint(w, h)
    self:DrawTextEntryText(color_white, Elib.Colors.Primary, Elib.Colors.Primary)
end
...
vgui.Register("Elib.TextEntryInternal", PANEL, "TextEntry")