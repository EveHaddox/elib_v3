...
function Elib.DrawOutlinedBox(x, y, w, h, thickness, col)
...
function Elib.DrawOutlinedRoundedBox(borderSize, x, y, w, h, col, thickness)
    thickness = thickness or 1

    setDrawColor(col.r, col.g, col.b, col.a)

    if borderSize <= 0 then
        Elib.DrawOutlinedBox(x, y, w, h, thickness, col)
        return
    end
